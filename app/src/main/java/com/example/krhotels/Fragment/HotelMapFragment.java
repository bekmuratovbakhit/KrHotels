...
public class HotelMapFragment extends Fragment implements
    ...
    private HotelMapFragment.CustomThemeManager customThemeManager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_hotel_map, container, false);
        ...
        try {
            getFeatureCollectionFromJson(location_hotel);
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(final MapboxMap mapboxMap) {
                ...
                customThemeManager = new HotelMapFragment.CustomThemeManager(chosenTheme, getContext());
